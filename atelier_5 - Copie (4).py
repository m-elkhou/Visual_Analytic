...
#            cv2.drawContours(frame, [cnt + (x, y)], -1, (0, 0, 255))
        ...
        # lien : https://docs.opencv.org/3.1.0/dd/d49/tutorial_py_contour_features.html
...
#            cv2.drawContours(frameD, [approx], 0, (0), 3)
        ...
        '''
    # find the keypoints and descriptors with SIFT      maskMOG2 or mask or frame_gray
#        frame_gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
#        frame_gray_min = frame_gray[ x:(x + width), y:(y + height)]
#        frame_gray[:,:] = 0
#        frame_gray[ x:(x + width), y:(y + height)] = frame_gray_min
#        keypoints, descriptors = sift.detectAndCompute(frame_gray_min,None)
        keypoints, descriptors = sift.detectAndCompute(maskMOG2,None)
